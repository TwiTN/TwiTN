      ...
      <div class="card-body space-y-5">
        ...
        <div class="form-control">
          <div class="flex items-center bg-black/10 border border-white/10 rounded-lg overflow-hidden">
            ...
            <input v-model="username" type="text" placeholder="Nom d'utilisateur" class="input bg-transparent text-white placeholder-white/70 border-none focus:outline-none w-full" @keyup.enter="submit"/>
          </div>
        </div>
        ...
        <div class="form-control">
          <div class="flex items-center bg-black/10 border border-white/10 rounded-lg overflow-hidden">
            ...
            <input v-model="password" type="password" placeholder="Mot de passe" class="input bg-transparent text-white placeholder-white/70 border-none focus:outline-none w-full" @keyup.enter="submit"/>
          </div>
        </div>

        <RouterLink to="/signup" class="flex items-center text-gray-400 hover:text-gray-300">
          <span class="font-medium text-xs underline">Pas de compte ? Inscris-toi</span>
          <span class="material-icons-outlined" style="font-size: 1.2rem">arrow_outward</span>
        </RouterLink>
