...
def make_success(status_code: int, message: str) -> tuple[dict[str, str], int]:
    """Create a standardized success response.
    Args:
        status_code (int): The HTTP status code for the success.
        message (str): A descriptive success message.
    Returns:
        tuple[dict[str, str], int]: A tuple containing the success message dictionary and the status code.
    """
